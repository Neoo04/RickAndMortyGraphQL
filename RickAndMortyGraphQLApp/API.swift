...
public final class GetAllCharachtersQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
    query GetAllCharachters {
      characters {
        __typename
        results {
          __typename
  ...
  public let operationName: String = "GetAllCharachters"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Character: GraphQLSelectionSet {
      ...
      public struct Result: GraphQLSelectionSet {
        ...
        public init(name: String? = nil, status: String? = nil, species: String? = nil, gender: String? = nil, image: String? = nil) {
          self.init(unsafeResultMap: ["__typename": "Character", "name": name, "status": status, "species": species, "gender": gender, "image": image])
        }
